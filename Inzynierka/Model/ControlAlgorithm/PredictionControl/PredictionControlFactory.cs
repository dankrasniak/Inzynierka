...
namespace Inzynierka.Model.ControlAlgorithm.PredictionControl
{
    public sealed class PredictionControlFactory : AAlgorithmFactory
    {
        ...
        public PredictionControlFactory()
        {
            ...
            Properties.Add(new Property("PredictionHorizon", 60, "Długość horyzontu predykcji", 0.00001, 20000.0)); // TODO
            Properties.Add(new Property("Discount", 1, "Wartość dyskonta dla wartości nagród na horyzoncie.", 0.01, 1.0));
            Properties.Add(new Property("StartSigma", 2.0, "Algorytm ewolucyjny, wartość sigmy.", 0.001, 20.0));
            Properties.Add(new Property("SigmaMin", 0.1, "Wartość minimalna sigmy.", 0.00001, 10.0));
            ...
            Properties.Add(new Property("TimeLimit", 7, "Limit czasu na jeden epizod.", 1, 1000));
